<?php include "includes/header.php" ?>
  ...
  <?php include "includes/topbar.php" ?>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">MIL Events</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>MIL Events <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
   ...
   <div style="margin-top:30px" class="blog-slider">
  <div class="blog-slider__wrp swiper-wrapper">
    <div class="blog-slider__item swiper-slide">
      ...
      <div class="blog-slider__content">
		...
		<form method="post" action="at_events.php">
		<input type="hidden" name="pass" value="'.$row['id'].'" />
		<button type="submit" name="events" class="blog-slider__button">READ MORE</button>
		</form>
