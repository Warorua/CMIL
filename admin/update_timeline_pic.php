...
$conn = $pdo->open();
$stmt = $conn->prepare("UPDATE timeline SET photo=:photo WHERE id=:id");
$stmt->execute(['photo'=>$filename, 'id'=>$id]);

$_SESSION['success'] = 'Timeline photo successfully updated!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not update the Timeline Photo!';
header('location:index.php');
}
?>
