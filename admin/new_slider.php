        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				?>
					...
					<form id="example-form" action="add_slider.php" method="post" enctype="multipart/form-data" class="mt-5">
                            <div>
                        
                                <section>
                                    <label for="name">Head *</label>
                                    <input id="name" name="head" type="text" class="required form-control" required="required">
                                    <label for="info">Caption *</label>
                                    <textarea style="width:100%; height:250px" name="content" type="text" class="form-control" required="required"></textarea>
                                ...
                                <section>
								<br />
									<button type="submit" name="slider" class="btn btn-primary">Add new</button>
