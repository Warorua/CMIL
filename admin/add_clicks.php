...
$conn = $pdo->open();
$stmt = $conn->prepare("INSERT INTO clicks (head, content, photo) VALUES (:head, :content, :photo)");
$stmt->execute(['head'=>$head, 'content'=>$content, 'photo'=>$filehead]);

$_SESSION['success'] = 'UNESCO clicks successfully added!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not add to UNESCO clicks!';
header('location:index.php');
}
?>
