    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add new Trustee member</h1>
					<form id="example-form" action="add_trustee.php" method="post" enctype="multipart/form-data" class="mt-5">
                            <div>
                                ...
                                <section>
								<br />
									<button type="submit" name="trustee" class="btn btn-primary">Add Trustee</button>
