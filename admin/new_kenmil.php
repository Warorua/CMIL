        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				?>
					...
					<form id="example-form" action="add_kenmil.php" method="post" enctype="multipart/form-data" class="mt-5">
                            <div>
                                ...
                                <section>
                                   ...
                                   <input type="hidden" name="auth" value="<?php echo $user['id']; ?>" />
                                    <p>(*) Mandatory</p>
                                </section>
                                <section>
								<br />
									<button type="submit" name="kenmil" class="btn btn-primary">Add New</button>
