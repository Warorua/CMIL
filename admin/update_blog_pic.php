...
$conn = $pdo->open();
$stmt = $conn->prepare("UPDATE blog SET photo=:photo WHERE id=:id");
$stmt->execute(['photo'=>$filename, 'id'=>$id]);

$_SESSION['success'] = 'CMIL Blog photo successfully updated!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not update the CMIL Blog photo!';
header('location:index.php');
}
?>
