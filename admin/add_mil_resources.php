...
$conn = $pdo->open();
$stmt = $conn->prepare("INSERT INTO mil_resources (head, content, photo) VALUES (:head, :content, :photo)");
$stmt->execute(['head'=>$head, 'content'=>$content, 'photo'=>$filehead]);

$_SESSION['success'] = 'MIL Resources successfully added!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not add to MIL Resources!';
header('location:index.php');
}
?>
