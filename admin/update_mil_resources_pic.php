...
$conn = $pdo->open();
$stmt = $conn->prepare("UPDATE mil_resources SET photo=:photo WHERE id=:id");
$stmt->execute(['photo'=>$filename, 'id'=>$id]);

$_SESSION['success'] = 'MIL Resources photo successfully updated!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not update the MIL Resources photo!';
header('location:index.php');
}
?>
