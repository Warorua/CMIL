...
$conn = $pdo->open();
$stmt = $conn->prepare("UPDATE slider SET photo=:photo WHERE id=:id");
$stmt->execute(['photo'=>$filename, 'id'=>$id]);

$_SESSION['success'] = 'slider photo successfully updated!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not update the slider Photo!';
header('location:index.php');
}
?>
