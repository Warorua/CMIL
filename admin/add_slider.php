...
$conn = $pdo->open();
$stmt = $conn->prepare("INSERT INTO slider (head, content, photo) VALUES (:head, :content, :photo)");
$stmt->execute(['head'=>$head, 'content'=>$content, 'photo'=>$filehead]);

$_SESSION['success'] = 'Slider successfully added!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not add into slider!';
header('location:index.php');
}
?>
