        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				?>
					...
					<form id="example-form" action="update_board_pic.php" method="post" enctype="multipart/form-data" class="mt-5">
                            <div>
                        <input type="hidden" name="pic" value="<?php echo $board['photo'];?>" />
						<section>
						<div class="col-md-3">
						<img src="includes/board/<?php echo $board['photo'];?>" width="100%" />
						</div>
						</section>
                                <section>
