...
$conn = $pdo->open();
$stmt = $conn->prepare("UPDATE kenmil SET photo=:photo WHERE id=:id");
$stmt->execute(['photo'=>$filename, 'id'=>$id]);

$_SESSION['success'] = 'Kenya MIL Alliance photo successfully updated!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not update the Kenya MIL Alliance photo!';
header('location:index.php');
}
?>
