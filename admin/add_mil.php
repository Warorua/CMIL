...
$conn = $pdo->open();
$stmt = $conn->prepare("INSERT INTO mil_africa (head, content, photo) VALUES (:head, :content, :photo)");
$stmt->execute(['head'=>$head, 'content'=>$content, 'photo'=>$filehead]);

$_SESSION['success'] = 'MIL in Africa successfully added!';
header('location:index.php');
}
else{
$_SESSION['error'] = 'Could not add to MIL in Africa!';
header('location:index.php');
}
?>
