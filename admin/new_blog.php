        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				?>
					...
					<form id="example-form" action="add_blog.php" method="post" enctype="multipart/form-data" class="mt-5">
                            <div>
                                ...
                                <section>
								<br />
									<button type="submit" name="blog" class="btn btn-primary">Add New</button>
