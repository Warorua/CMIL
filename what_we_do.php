      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">What We Do</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>What We Do <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
          	...
          	<h2 class="mb-4">What We Do</h2>
						<div class="row mt-5">
							<div class="col-lg-12">
								...
								<?php
	  $conn = $pdo->open();
	  $stmt = $conn->prepare("SELECT * FROM what_we_do_photo");
	  $stmt->execute();
	  foreach($stmt as $row){
	  echo '
      <div class="row">
      <div class="col-md-12">
       <img src="admin/includes/gallery/'.$row['photo'].'" width="100%" style="margin-top:25px; border-radius:7px" alt="'.$row['date'].'" />
      </div>
      </div>
