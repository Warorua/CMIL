    ...
    <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url(gal1.jpg); background-size:100%" data-stellar-background-ratio="0.5">
    	<div class="container">
    		<div class="row justify-content-end">
	          ...
	          <form  method="post" action="verify.php" class="appointment-form ftco-animate">
		            ...
		            <div class="form-group ml-md-4">
		              <a href="password_forgot.php" class="btn btn-outline-secondary py-3 px-4">Forgot password</a>
		            </div>
	    				</div>
	    			</form>
    			</div>
